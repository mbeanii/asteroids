...
public:
   ...
   Interface()
   {
      Color bgColor(0x111111);
      initialize(0, 0x0000, "Window", bgColor);
   }

   // Constructor if you want to set up the window with anything but
   // the default parameters
   Interface(int argc, char ** argv, const char * title, Color bgColor)
   {
      initialize(argc, argv, title, bgColor);
   }
...
private:
   ...
   void initialize(int argc, char ** argv, const char * title, Color bgColor);
