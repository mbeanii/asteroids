 ...
 * Author:
 *     Br. Helfrich
 *     Brandon Hartshorn - Changed the background color! (Oooooh... pretty!)
 ************************************************************************/
                           ...
                           Color bgColor)
{
   ...
   // AHA I FOUND IT IT'S RIGHT HERE!
   // Whatever I say is the background color
   glClearColor(bgColor.getFloat('r'), bgColor.getFloat('g'), bgColor.getFloat('b'), 0);
